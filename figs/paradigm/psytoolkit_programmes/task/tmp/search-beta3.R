...
# The drafting of first beta version started on 10th of Dec and was finished on 
# 19th of December, 2011. Author: Yi-Shin Lin
# --------------------------------------------------------------------------------------
rm(list=ls())
...
iLength = 51                        # numbers of repetition
isiSet =  c(50, 400)                # c(50, 400)
setsizeSet =  c(3, 7, 9)
targetPosSet = c(7,1)  # 7-left; 1-right  c(5, 6)              # 5-left; 6-right
    ...
    for (isi in isiSet) 
      ...
      for (setsize in setsizeSet)             
        ...
        for (targetPos in targetPosSet)       # 5-left; 6-right
          ...
          #---------------------------------------------------
          if (targetPos==7)  {                       # if target is on the left side.
